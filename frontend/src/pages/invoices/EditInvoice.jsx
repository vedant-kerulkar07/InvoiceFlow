...
const EditInvoice = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      /*
       * Do NOT send invoiceNumber.
       *
       * Backend automatically generated it
       * when this invoice was created and
       * does not allow it to be edited.
       */
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-1 text-sm text-[#6B6785]">
            Update invoice details, items and billing
            information.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              {invoiceNumber && (
                <span className="inline-flex w-fit rounded-full bg-violet-50 px-3 py-1 text-xs font-semibold text-violet-700">
                  {invoiceNumber}
                </span>
              )}
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 sm:gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="flex min-h-[48px] items-center rounded-xl border border-violet-200 bg-violet-50 px-4">
